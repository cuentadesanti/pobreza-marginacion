...
| **Trejo & Ley (HPCV)** | **political_coercion** | ✅ Dataverse verificado (`doi:10.7910/DVN/VIXNNE`): dataset + **codebook PDF + .do files** listados. Cobertura 1995–2012 (histórica). Confirmar unidad municipal en el codebook al descargar |
...
| **MCO (Signoret/Sobrino et al.)** | candidate_unverified | El proyecto existe (6 autores; DDSS Princeton lo destaca; ~2,500 municipios anual); la página promete plataforma pública **en futuro desde 2019** y la descarga no está localizada; DDSS devolvió 403. → email a autores |
